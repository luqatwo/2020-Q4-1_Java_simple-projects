class Main {
    public static void main(String[] args) {
        ...
        System.out.println ("");
        /// < komentarz 1-22... dodatkowa pusta linijka >
        ...
        /// < komentarz 2-22 [A1]... metoda wyświetaljąca cenę regularną za jeden telefon LuqaszPhone 3s LTE - w tym przypadku jest to 750$ >

        int newitemValue = phone.price - (phone.price / phone.discount);
        /// < komentarz 3-22 [A2]... metoda obniżająca cenę o ustaloną wartość procentową - w tym przypadku obniżka to 10% >
        ...
        /// < komentarz 4-22 [A3]... metoda zwiększająca cenę o wartość przekazaną w argumencie - w tym przypadku jest to zwiększenie ceny o wartość wynoszącą 150 >
        ...
        /// < komentarz 5-22... ponowione wyświetlanie tekstu (brand, weight, price) - odniesienie do kodu z klasy MobilePhone >
        ...
        /// < komentarz 6-22... wyświetlanie wartości dla kolejnego (odnowionego) telefonu wraz z wykorzystaniem metod obliczeniowych, tj. wyświetlenie ceny regularnej, obliczenie nowej ceny po przecenie oraz kolejnej ceny po podwyższce >
        ...
        /// < komentarz 7-22... wyświetlanie wartości dla kolejnego (starego) telefonu wraz z wykorzystaniem metod obliczeniowych, tj. wyświetlenie ceny regularnej, obliczenie nowej ceny po przecenie oraz kolejnej ceny po podwyższce >

        phone.checkPrice ();
        renewedphone.checkPrice ();
        oldphone.checkPrice ();

        /// < komentarz 8-22... weryfikowanie, sprawdzanie ceny poszczególnych telefonów komórkowych LuqaszPhone - odniesienie do kodu z klasy MobilePhone >
        ...
        /// < komentarz 9-22... wyświetlanie poszczególnych numerów z zakresów min i max, które są podzielne przez wskazaną liczbę - odniesienie do kodu z klasy MobilePhone >
        ...
        /// < komentarz 10-22 [B1.1]... wyświetlanie liczb z zakresów min i max (4,18 oraz 3,12), które są podzielne przez liczbę 3 (dla 4,18) oraz 5 (dla 3,12) - odniesienie do kodu z klasy MobilePhone >

        phone.text2 ();

        phone.getEvenSum (5,9);

        /// < komentarz 11-22 [B2.1]... wyświetlanie liczb parzystych z zakresów min i max (5,9), które są podzielne przez 2 - odniesienie do kodu z klasy MobilePhone >

        phone.text3 ();

        phone.getNumber (5,-2);

        /// < komentarz 12-22 [B3.1]... wyświetlanie wszystkich liczb z zakresów min i max (5,9) w kolejności malejącej - odniesienie do kodu z klasy MobilePhone >
